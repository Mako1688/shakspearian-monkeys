...
const WORD_LIST: readonly string[] = [
  ...
  "low","man","map","met","mix","net","nor","nor","oil","pay","pen","per","pet",
  ...
  "helpful","helpful","highway","history","holding","holiday","horizon","housing",
  ...
  "nuclear","nursing","observe","officer","operate","opinion","organic","pointed",
  // 8-letter words
  ...
  "literary","lifetime","lighting","likeness","limiting","lingered","literacy",
